...
from tests.acceptance.backends.test_braket_backend import BACKEND_ID_AWS_SV1, BACKEND_ID_AWS_IONQ_ARIA
from tests.acceptance.backends.test_braket_job import BRAKET_NAME_SV1, BRAKET_NAME_IONQ_ARIA
